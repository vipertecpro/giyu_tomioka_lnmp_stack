...
@section('appContent')
    <section class="bg-white dark:bg-gray-900">
        <div class="max-w-screen-xl px-4 py-8 mx-auto sm:py-16 lg:py-24 pt-20 sm:pt-24 lg:pt-36">
            <div class="max-w-3xl mx-auto text-center">
                ...
                <p class="mt-4 text-base text-gray-500 sm:text-xl dark:text-gray-400">
                    We are strategists, designers and developers. Innovators and problem solvers. Small enough to be simple, quick
                    and
                    creative.
                </p>
            </div>
            <iframe class="w-full h-64 max-w-2xl mx-auto mt-8 rounded-lg lg:mt-12 sm:h-96"
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="max-w-screen-xl px-4 pb-8 mx-auto sm:pb-16 lg:pb-24">
            <div class="grid grid-cols-1 gap-8 text-center md:grid-cols-2 md:gap-12">
                <div>
                    <div class="inline-flex items-center justify-center w-24 h-24 rounded-lg bg-primary-100 dark:bg-primary-900">
                    ...
                    <h3 class="mt-5 text-2xl font-bold dark:text-white">
                        Just the right balance for growth
                    </h3>
                    <p class="mt-4 text-gray-500 dark:text-gray-400">
                        Enterprise tools cost more, are difficult to use, and take longer to implement. According to G2, Flowbite is
                        the
                        easiest-to-use tool, with the fastest time to ROI.
                    </p>
                </div>

                <div>
                    <div class="inline-flex items-center justify-center w-24 h-24 bg-purple-100 rounded-lg dark:bg-purple-900">
                    ...
                    <p class="mt-4 text-gray-500 dark:text-gray-400">
                        Third party research shows Flowbite has a net promoter score of 31, while our competitors’ score is 2. The
                        market has
                        spoken—more customers are satisfied with our platform and service.
                    </p>
                </div>
            </div>
    ...
    <section class="border-t border-b border-gray-100 bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
        <div class="max-w-screen-xl px-4 py-8 mx-auto sm:py-16 lg:py-24">
            ...
            <p class="mt-8 text-base font-normal text-gray-500 sm:text-xl dark:text-gray-400 sm:mt-12">
                Want to see more?
            </p>
            <div class="grid gap-8 mt-4 lg:grid-cols-2">
                <a href="#"
                   class="inline-flex items-center justify-center p-5 text-base font-medium text-gray-500 bg-gray-100 rounded-lg hover:text-gray-900 hover:bg-gray-200 dark:text-gray-400 dark:bg-gray-700 dark:hover:bg-gray-600 dark:hover:text-white">
                    <svg class="w-5 h-5 mr-3" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                        ...
                        <defs>
                            <linearGradient id="paint0_linear_4151_62980" x1="20.0604" y1="23.7696" x2="23.2079" y2="12.8065"
                                            gradientUnits="userSpaceOnUse">
                                <stop stop-color="#1724C9" />
                                <stop offset="1" stop-color="#1C64F2" />
                            </linearGradient>
                            <linearGradient id="paint1_linear_4151_62980" x1="27.3093" y1="10.4001" x2="19.0297" y2="2.14962"
                                            gradientUnits="userSpaceOnUse">
                                <stop stop-color="#1C64F2" />
                                <stop offset="1" stop-color="#0092FF" />
                            </linearGradient>
                            <linearGradient id="paint2_linear_4151_62980" x1="16.1642" y1="5.0209" x2="3.67407" y2="5.81015"
                                            gradientUnits="userSpaceOnUse">
                                <stop stop-color="#0092FF" />
                                <stop offset="1" stop-color="#45B2FF" />
                            </linearGradient>
                            <linearGradient id="paint3_linear_4151_62980" x1="15.32" y1="28.6624" x2="26.5369" y2="25.6356"
                                            gradientUnits="userSpaceOnUse">
                                <stop stop-color="#1C64F2" />
                                <stop offset="1" stop-color="#0092FF" />
                            </linearGradient>
                            <linearGradient id="paint4_linear_4151_62980" x1="7.26808" y1="15.6825" x2="15.2317" y2="23.9345"
                                            gradientUnits="userSpaceOnUse">
                                <stop stop-color="#1724C9" />
                                <stop offset="1" stop-color="#1C64F2" />
                            </linearGradient>
                            <linearGradient id="paint5_linear_4151_62980" x1="25.4497" y1="21.6353" x2="31.0061" y2="10.4342"
                                            gradientUnits="userSpaceOnUse">
                                <stop stop-color="#0092FF" />
                                <stop offset="1" stop-color="#45B2FF" />
                            </linearGradient>
                            <linearGradient id="paint6_linear_4151_62980" x1="5.36387" y1="9.13067" x2="2.39054" y2="20.3063"
                                            gradientUnits="userSpaceOnUse">
                                <stop stop-color="#1C64F2" />
                                <stop offset="1" stop-color="#0092FF" />
                            </linearGradient>
                            <linearGradient id="paint7_linear_4151_62980" x1="20.5432" y1="8.59912" x2="9.6778" y2="11.3044"
                                            gradientUnits="userSpaceOnUse">
                                <stop stop-color="#1724C9" />
                                <stop offset="1" stop-color="#1C64F2" />
                            </linearGradient>
                            <linearGradient id="paint8_linear_4151_62980" x1="6.40691" y1="21.3563" x2="13.3327" y2="31.7743"
                                            gradientUnits="userSpaceOnUse">
                                <stop stop-color="#0092FF" />
                                <stop offset="1" stop-color="#45B2FF" />
                            </linearGradient>
                ...
                <a href="#"
                   class="inline-flex items-center justify-center p-5 text-base font-medium text-gray-500 bg-gray-100 rounded-lg hover:text-gray-900 hover:bg-gray-200 dark:text-gray-400 dark:bg-gray-700 dark:hover:bg-gray-600 dark:hover:text-white">
                    <svg class="w-5 h-5 mr-3" viewBox="0 0 22 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="#"
                   class="inline-flex items-center justify-center p-5 text-base font-medium text-gray-500 bg-gray-100 rounded-lg hover:text-gray-900 hover:bg-gray-200 dark:text-gray-400 dark:bg-gray-700 dark:hover:bg-gray-600 dark:hover:text-white">
                    <svg class="w-5 h-5 mr-3" viewBox="0 0 26 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="#"
                   class="inline-flex items-center justify-center p-5 text-base font-medium text-gray-500 bg-gray-100 rounded-lg hover:text-gray-900 hover:bg-gray-200 dark:text-gray-400 dark:bg-gray-700 dark:hover:bg-gray-600 dark:hover:text-white">
                    <svg class="w-5 h-5 mr-3" viewBox="0 0 33 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                        ...
                        <defs>
                            <linearGradient id="paint0_linear_4151_63014" x1="-0.91663" y1="6.56015" x2="27.5845" y2="22.9931"
                                            gradientUnits="userSpaceOnUse">
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="max-w-screen-xl px-4 py-8 mx-auto sm:py-16 lg:py-24">
            <div class="max-w-3xl mx-auto text-center">
                ...
                <div class="mt-4">
                    <a href="#"
                       class="inline-flex items-center justify-center text-base font-medium text-primary-700 hover:underline dark:text-primary-500">
                        Learn more about us
            ...
            <div class="max-w-screen-xl mx-auto mt-8 sm:mt-12 lg:mt-16">
                <div id="animation-carousel" class="relative px-16 sm:px-24" data-carousel="slide">
                    <div class="relative h-32 overflow-hidden rounded-lg sm:h-64 xl:h-80 2xl:h-80">
                        <div
                            class="absolute inset-0 grid hidden gap-8 transition-all duration-700 ease-linear transform lg:grid-cols-2"
                            data-carousel-item="">
                            <img
          ...
          <span
            ...
            <dl
                class="grid max-w-screen-xl grid-cols-2 gap-8 mx-auto mt-10 text-center text-gray-900 sm:grid-cols-3 xl:grid-cols-6 dark:text-white">
                <div class="flex flex-col items-center justify-center">
                    <dt class="mb-2 text-3xl font-extrabold sm:text-4xl">73M+</dt>
                    <dd class="text-gray-500 dark:text-gray-400">Developers</dd>
                </div>
                <div class="flex flex-col items-center justify-center">
                    <dt class="mb-2 text-3xl font-extrabold sm:text-4xl">100M+</dt>
                    <dd class="text-gray-500 dark:text-gray-400">Public repositories</dd>
                </div>
                <div class="flex flex-col items-center justify-center">
                    <dt class="mb-2 text-3xl font-extrabold sm:text-4xl">1000s</dt>
                ...
                <div class="flex flex-col items-center justify-center">
                    <dt class="mb-2 text-3xl font-extrabold sm:text-4xl">90+</dt>
