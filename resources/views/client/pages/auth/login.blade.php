    ...
    <div class="w-full place-self-center lg:col-span-6">
        <div class="p-6 mx-auto bg-white rounded-lg shadow dark:bg-gray-800 sm:max-w-xl sm:p-8">
            ...
            <p class="text-sm font-light text-gray-500 dark:text-gray-300">
                Start your website in seconds. Don’t have an account? <a href="{{ route('client.register') }}" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Register Here</a>.
            </p>
            <form class="mt-4 space-y-6 sm:mt-6" action="#">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('client.forgetPassword') }}" class="text-sm font-medium text-primary-600 hover:underline dark:text-primary-500">Forgot password?</a>
                </div>
