                    ...
                    <div class="grid grid-cols-1">
                        <div class="w-full border border-gray-200 rounded bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                            ...
                            <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                                ...
                                <div id="wysiwyg-example" class="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400 min-h-96"></div>
                            </div>
                        </div>
                    </div>
                </div>
