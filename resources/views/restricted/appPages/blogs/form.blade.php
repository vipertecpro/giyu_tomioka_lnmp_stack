    ...
    <form action="{{ route('app.dashboard.blogs.form') }}" method="POST" class="relative p-2">
        ...
        <div class="grid grid-cols-12 sm:grid-cols-1 md:grid-cols-12 gap-4 ">
            <div class="col-span-12 lg:col-span-3 space-y-4">
                ...
                <div class="col-span-12">
                    @include('restricted.appPages.blogs.widgets.featuredImage')
                </div>
                <div class="col-span-12">
                    @include('restricted.appPages.blogs.widgets.categories')
                </div>
                <div class="col-span-12">
                    @include('restricted.appPages.blogs.widgets.tags')
                </div>
            </div>
