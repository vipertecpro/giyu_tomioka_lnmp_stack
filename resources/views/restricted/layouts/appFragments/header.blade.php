<nav class="bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
    <div class="flex flex-wrap justify-between items-center">
        <div class="flex justify-start items-center">
            ...
            <a href="{{ route('app.dashboard.index') }}" class="flex items-center justify-between mr-4">
                <img
                    src="{{ asset('assets/images/logo.jpg') }}"
                    class="mr-3 h-8"
                    alt="{{ env('APP_NAME') }}"
                />
                <span class="hidden md:block text-gray-800 dark:text-white">{{ env('APP_NAME') }}</span>
            </a>
        </div>
              ...
              <span
                ...
                >
                    <li>
                        ...
                        <form id="logout-form" method="POST" action="{{ route('app.dashboard.logout') }}">
                            @csrf
