            ...
            <div class="relative group">
                <div class="h-full min-h-[200px] max-h-[300px] overflow-y-auto">
                    @if(@$pageData->featured_image)
                        <img class="rounded-md object-contain w-full min-h-[200px] max-h-[300px] previewPlaceholder" src="{{ asset('storage/'.@$pageData->featured_image) }}" data-preview-default-url="https://placehold.co/1280x720?text=Placeholder%0A1280x720" alt="Featured Image Placeholder" />
                    @else
                ...
                <div class="absolute inset-0 flex items-end justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-200 bg-gray-800 bg-opacity-20 dark:bg-gray-800 dark:bg-opacity-20 backdrop-blur-sm rounded-md">
                    <div class="flex space-x-2 mb-2">
                        <button type="button" class="text-white bg-yellow-700 hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-md text-sm p-2 text-center items-center dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800 {{ @$pageData->featured_image ? 'inline-flex' : 'hidden' }}" data-widget-action="edit">
                            <svg class="w-4 h-4 text-inherit" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <button type="button" class="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-md text-sm p-2 text-center items-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800  {{ @$pageData->featured_image ? 'hidden' : 'inline-flex' }}" data-widget-action="add">
                        ...
                        <button type="button" class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-md text-sm p-2 text-center items-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800  {{ @$pageData->featured_image ? 'inline-flex' : 'hidden' }}" data-widget-action="remove">
                            <svg class="w-4 h-4 text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
