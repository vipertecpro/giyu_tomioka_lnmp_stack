<div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 border-t dark:border-gray-600 flex flex-col">
    <div class="p-2 flex flex-col">
        <div class="flex-1 w-full md:max-w-sm md:mr-2">
            ...
            <div class="relative">
                ...
                <input id="tags-widget-search" data-widget-action="search" type="search" class="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Search tags">
    ...
    <div class="flex-grow overflow-x-auto">
        <table class="relative w-full text-sm text-left text-gray-500 dark:text-gray-400" id="widget-list">
            ...
            <tbody class="block max-h-48 overflow-y-auto" data-render-widget-list-api="{{ route('internal.widgets.tags') }}"></tbody>
        </table>
    </div>
